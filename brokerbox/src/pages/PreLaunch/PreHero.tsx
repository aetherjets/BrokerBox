      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Become a Founding Broker of
              <motion.span 
                className="block bg-clip-text bg-gradient-to-r from-stone-700 to-stone-500"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <b>38 brokers</b> have already secured their founding status
              </motion.span>
            </motion.div>
          </motion.div>

          {/* Right side - Image with pricing badge */}
          <motion.div
          ...
          >
            <div className="relative">
              ...
              >
                <div>
                  <div className="font-bold text-4xl mb-1">£640</div>
                  <div className="text-sm text-stone-600 mb-1">One-time payment</div>
                  <div className="text-sm text-stone-600">for 12 months access</div>
                </div>
              </motion.div>

              <motion.div
                className="absolute -top-4 -left-4 bg-stone-100 rounded-lg shadow-lg py-2 px-4 text-center"
                initial={{ scale: 0, rotate: 10 }}
                animate={{ scale: 1, rotate: 0 }}
                transition={{ type: "spring", stiffness: 300, delay: 1.1 }}
              >
                <div className="text-sm font-medium text-stone-900">Only 12 spots left!</div>
              </motion.div>
            </div>
          </motion.div>
        </div>
